...
<html>
  <head>
    ...
    <link href="<?php echo e(url('css/yasin.css')); ?>" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <h4 class="titel text-center">{!! CRUDBooster::getSetting('head_title') !!}</h4>
        <h5 class="titel text-center">{!! CRUDBooster::getSetting('sub_title') !!}</h5>
        <hr class="titel"/>
